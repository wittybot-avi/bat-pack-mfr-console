 ...
 * Single source of truth for the application's URL structure.
 */
export const ROUTES = {
  DASHBOARD: '/',
  LOGIN: '/login',
  ...
  // Trace
  CELL_SERIALIZATION: '/trace/cell-serialization',
  CELL_LOT_DETAIL: '/trace/cell-serialization/:lotId',
  LINEAGE_AUDIT: '/trace/lineage-audit',
  LINEAGE_AUDIT_DETAIL: '/trace/lineage-audit/:id',
