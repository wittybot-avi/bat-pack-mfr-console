...
// Fix: Added icon property to RouteLedgerEntry interface to match usage in Layout.tsx
...
/**
 * CANONICAL ROUTE LEDGER - P-056H2 STABLE
 * Every navigable path MUST be registered here to prevent "Unknown Coordinates".
 */
